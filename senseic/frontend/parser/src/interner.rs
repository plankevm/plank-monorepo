...
impl PlankInterner {
    ...
    pub const NEVER_TYPE_NAME: StrId = StrId::new(6);

    // ========== EVM Arithmetic ==========
    pub const ADD: StrId = StrId::new(7);
    pub const MUL: StrId = StrId::new(8);
    pub const SUB: StrId = StrId::new(9);
    pub const DIV: StrId = StrId::new(10);
    pub const SDIV: StrId = StrId::new(11);
    pub const MOD: StrId = StrId::new(12);
    pub const SMOD: StrId = StrId::new(13);
    pub const ADDMOD: StrId = StrId::new(14);
    pub const MULMOD: StrId = StrId::new(15);
    pub const EXP: StrId = StrId::new(16);
    pub const SIGNEXTEND: StrId = StrId::new(17);

    // ========== EVM Comparison & Bitwise Logic ==========
    pub const LT: StrId = StrId::new(18);
    pub const GT: StrId = StrId::new(19);
    pub const SLT: StrId = StrId::new(20);
    pub const SGT: StrId = StrId::new(21);
    pub const EQ: StrId = StrId::new(22);
    pub const ISZERO: StrId = StrId::new(23);
    pub const AND: StrId = StrId::new(24);
    pub const OR: StrId = StrId::new(25);
    pub const XOR: StrId = StrId::new(26);
    pub const NOT: StrId = StrId::new(27);
    pub const BYTE: StrId = StrId::new(28);
    pub const SHL: StrId = StrId::new(29);
    pub const SHR: StrId = StrId::new(30);
    pub const SAR: StrId = StrId::new(31);

    // ========== EVM Keccak-256 ==========
    pub const KECCAK256: StrId = StrId::new(32);

    // ========== EVM Environment Information ==========
    pub const ADDRESS: StrId = StrId::new(33);
    pub const BALANCE: StrId = StrId::new(34);
    pub const ORIGIN: StrId = StrId::new(35);
    pub const CALLER: StrId = StrId::new(36);
    pub const CALLVALUE: StrId = StrId::new(37);
    pub const CALLDATALOAD: StrId = StrId::new(38);
    pub const CALLDATASIZE: StrId = StrId::new(39);
    pub const CALLDATACOPY: StrId = StrId::new(40);
    pub const CODESIZE: StrId = StrId::new(41);
    pub const CODECOPY: StrId = StrId::new(42);
    pub const GASPRICE: StrId = StrId::new(43);
    pub const EXTCODESIZE: StrId = StrId::new(44);
    pub const EXTCODECOPY: StrId = StrId::new(45);
    pub const RETURNDATASIZE: StrId = StrId::new(46);
    pub const RETURNDATACOPY: StrId = StrId::new(47);
    pub const EXTCODEHASH: StrId = StrId::new(48);
    pub const GAS: StrId = StrId::new(49);

    // ========== EVM Block Information ==========
    pub const BLOCKHASH: StrId = StrId::new(50);
    pub const COINBASE: StrId = StrId::new(51);
    pub const TIMESTAMP: StrId = StrId::new(52);
    pub const NUMBER: StrId = StrId::new(53);
    pub const DIFFICULTY: StrId = StrId::new(54);
    pub const GASLIMIT: StrId = StrId::new(55);
    pub const CHAINID: StrId = StrId::new(56);
    pub const SELFBALANCE: StrId = StrId::new(57);
    pub const BASEFEE: StrId = StrId::new(58);
    pub const BLOBHASH: StrId = StrId::new(59);
    pub const BLOBBASEFEE: StrId = StrId::new(60);

    // ========== EVM State Manipulation ==========
    pub const SLOAD: StrId = StrId::new(61);
    pub const SSTORE: StrId = StrId::new(62);
    pub const TLOAD: StrId = StrId::new(63);
    pub const TSTORE: StrId = StrId::new(64);

    // ========== EVM Logging Operations ==========
    pub const LOG0: StrId = StrId::new(65);
    pub const LOG1: StrId = StrId::new(66);
    pub const LOG2: StrId = StrId::new(67);
    pub const LOG3: StrId = StrId::new(68);
    pub const LOG4: StrId = StrId::new(69);

    // ========== EVM System Calls ==========
    pub const CREATE: StrId = StrId::new(70);
    pub const CREATE2: StrId = StrId::new(71);
    pub const CALL: StrId = StrId::new(72);
    pub const CALLCODE: StrId = StrId::new(73);
    pub const DELEGATECALL: StrId = StrId::new(74);
    pub const STATICCALL: StrId = StrId::new(75);
    pub const RETURN: StrId = StrId::new(76);
    pub const STOP: StrId = StrId::new(77);
    pub const REVERT: StrId = StrId::new(78);
    pub const INVALID: StrId = StrId::new(79);
    pub const SELFDESTRUCT: StrId = StrId::new(80);

    // ========== IR Memory Primitives ==========
    pub const DYNAMIC_ALLOC_ZEROED: StrId = StrId::new(81);
    pub const DYNAMIC_ALLOC_ANY_BYTES: StrId = StrId::new(82);

    // ========== Memory Manipulation ==========
    pub const MEMORY_COPY: StrId = StrId::new(83);
    pub const MLOAD1: StrId = StrId::new(84);
    pub const MLOAD2: StrId = StrId::new(85);
    pub const MLOAD3: StrId = StrId::new(86);
    pub const MLOAD4: StrId = StrId::new(87);
    pub const MLOAD5: StrId = StrId::new(88);
    pub const MLOAD6: StrId = StrId::new(89);
    pub const MLOAD7: StrId = StrId::new(90);
    pub const MLOAD8: StrId = StrId::new(91);
    pub const MLOAD9: StrId = StrId::new(92);
    pub const MLOAD10: StrId = StrId::new(93);
    pub const MLOAD11: StrId = StrId::new(94);
    pub const MLOAD12: StrId = StrId::new(95);
    pub const MLOAD13: StrId = StrId::new(96);
    pub const MLOAD14: StrId = StrId::new(97);
    pub const MLOAD15: StrId = StrId::new(98);
    pub const MLOAD16: StrId = StrId::new(99);
    pub const MLOAD17: StrId = StrId::new(100);
    pub const MLOAD18: StrId = StrId::new(101);
    pub const MLOAD19: StrId = StrId::new(102);
    pub const MLOAD20: StrId = StrId::new(103);
    pub const MLOAD21: StrId = StrId::new(104);
    pub const MLOAD22: StrId = StrId::new(105);
    pub const MLOAD23: StrId = StrId::new(106);
    pub const MLOAD24: StrId = StrId::new(107);
    pub const MLOAD25: StrId = StrId::new(108);
    pub const MLOAD26: StrId = StrId::new(109);
    pub const MLOAD27: StrId = StrId::new(110);
    pub const MLOAD28: StrId = StrId::new(111);
    pub const MLOAD29: StrId = StrId::new(112);
    pub const MLOAD30: StrId = StrId::new(113);
    pub const MLOAD31: StrId = StrId::new(114);
    pub const MLOAD32: StrId = StrId::new(115);
    pub const MSTORE1: StrId = StrId::new(116);
    pub const MSTORE2: StrId = StrId::new(117);
    pub const MSTORE3: StrId = StrId::new(118);
    pub const MSTORE4: StrId = StrId::new(119);
    pub const MSTORE5: StrId = StrId::new(120);
    pub const MSTORE6: StrId = StrId::new(121);
    pub const MSTORE7: StrId = StrId::new(122);
    pub const MSTORE8: StrId = StrId::new(123);
    pub const MSTORE9: StrId = StrId::new(124);
    pub const MSTORE10: StrId = StrId::new(125);
    pub const MSTORE11: StrId = StrId::new(126);
    pub const MSTORE12: StrId = StrId::new(127);
    pub const MSTORE13: StrId = StrId::new(128);
    pub const MSTORE14: StrId = StrId::new(129);
    pub const MSTORE15: StrId = StrId::new(130);
    pub const MSTORE16: StrId = StrId::new(131);
    pub const MSTORE17: StrId = StrId::new(132);
    pub const MSTORE18: StrId = StrId::new(133);
    pub const MSTORE19: StrId = StrId::new(134);
    pub const MSTORE20: StrId = StrId::new(135);
    pub const MSTORE21: StrId = StrId::new(136);
    pub const MSTORE22: StrId = StrId::new(137);
    pub const MSTORE23: StrId = StrId::new(138);
    pub const MSTORE24: StrId = StrId::new(139);
    pub const MSTORE25: StrId = StrId::new(140);
    pub const MSTORE26: StrId = StrId::new(141);
    pub const MSTORE27: StrId = StrId::new(142);
    pub const MSTORE28: StrId = StrId::new(143);
    pub const MSTORE29: StrId = StrId::new(144);
    pub const MSTORE30: StrId = StrId::new(145);
    pub const MSTORE31: StrId = StrId::new(146);
    pub const MSTORE32: StrId = StrId::new(147);

    // ========== Bytecode Introspection ==========
    pub const RUNTIME_START_OFFSET: StrId = StrId::new(148);
    pub const INIT_END_OFFSET: StrId = StrId::new(149);
    pub const RUNTIME_LENGTH: StrId = StrId::new(150);
    ...
    fn inject_primitives(interner: &mut StringInterner<StrId>) {
        ...
        assert_eq!(interner.intern(builtin_names::NEVER_TYPE_NAME), Self::NEVER_TYPE_NAME);
