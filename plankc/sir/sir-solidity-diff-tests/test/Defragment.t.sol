...
contract DefragmentTest is BaseTest {
    function test_defragment_simpleAdd() public {
        ...
        bytes memory codeWith = sir(abi.encode("src/simple_add.sir", "--init-only", "--passes", "d"));
    ...
    function test_defragment_arithmeticLogic() public {
        ...
        bytes memory initWith = sir(abi.encode("src/arithmetic_logic.sir", "--passes", "d"));
    ...
    function test_defragment_followTheList() public {
        ...
        bytes memory codeWith = sir(abi.encode("src/follow_the_list.sir", "--init-only", "--passes", "d"));
    ...
    function test_defragment_switchBug() public {
        ...
        bytes memory codeWith = sir(abi.encode("src/switch_bug.sir", "--init-only", "--passes", "d"));
    ...
    function test_defragment_simpleDataRet() public {
        ...
        bytes memory initWith = sir(abi.encode("src/simple_data_ret.sir", "--passes", "d"));
    ...
    function test_defragment_copyPropBranch() public {
        ...
        bytes memory codeWith = sir(abi.encode("src/copy_prop_branch.sir", "--init-only", "--passes", "d"));
    ...
    function test_defragment_copyPropSwitch() public {
        ...
        bytes memory codeWith = sir(abi.encode("src/copy_prop_switch.sir", "--init-only", "--passes", "d"));
    ...
    function test_defragment_constProp() public {
        ...
        bytes memory codeWith = sir(abi.encode("src/const_prop.sir", "--init-only", "--passes", "d"));
    ...
    function test_defragment_deadCodeElimination() public {
        ...
        bytes memory codeAfter = sir(abi.encode("src/defragment_dead_code.sir", "--init-only", "--passes", "d"));
