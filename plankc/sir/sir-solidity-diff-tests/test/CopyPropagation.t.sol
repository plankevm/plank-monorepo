...
contract CopyPropagationTest is BaseTest {
    function test_copyPropagation_noCopies_doesNotBreak() public {
        ...
        bytes memory codeWith = sir(abi.encode("src/simple_add.sir", "--init-only", "--passes", "c"));
    ...
    function test_copyPropagation_branch_withChain() public {
        ...
        bytes memory sirCode = sir(abi.encode("src/copy_prop_branch.sir", "--init-only", "--passes", "c"));
    ...
    function test_copyPropagation_switch_withOutput() public {
        ...
        bytes memory sirCode = sir(abi.encode("src/copy_prop_switch.sir", "--init-only", "--passes", "c"));
