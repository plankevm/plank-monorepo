...
impl StaticMemoryLayout {
    pub fn new(ir: &EthIRProgram) -> Self {
        ...
        Self { switch_store, free_pointer, locals_start, function_return_destinations, next_free }
    }
    ...
    pub fn emit_local_load(&self, asm: &mut Assembler, local: LocalId) {
    ...
    pub fn emit_free_ptr_load(&self, asm: &mut Assembler) {
