...
contract EventDiffTest is BaseTest {
    // Every `emit` dispatch arm (LOG0 through LOG4), every supported field type
    // indexed and not, empty and mixed static/dynamic data sections, and
    // `bytes` length edge cases.
